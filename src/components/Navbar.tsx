...
function Navbar({ items, onNavigate }: Props) {
  return (
    <div className="shadow-sm fixed top-10 left-1/2 -translate-x-1/2 w-[50%] min-w-[330px] bg-white/20 backdrop-blur-lg rounded-2xl border border-white/30 p-6 text-white text-xl font-bold overflow-hidden transition-all duration-200 animate-showup z-10 ">
